...
def history(symbol,datestart,dateend):
   ...
   # sellorder = []
    ...
    # print("Profit6")
        ...
        totalprofitallwithkoef = totalprofitall*koef - (signals*0.03) #Commision
        print("Профит")
        print(totalprofitallwithkoef)
        
        plt.figure(figsize=(20,10))

        plt.plot(table600[['Close','MA','Upper1','Lower1','Upper2','Lower2','Upper3','Lower3','LowerStop','UpperStop']])
