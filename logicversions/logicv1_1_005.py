   ...
   # sellorder = []
    ...
    for i in range(len(table600)):
        ...
        if open_posL1 == False:
            ...
            if table600.MA.iloc[i]*0.995<table600.High.iloc[i]:
...
#--------------------------------------------------------------------------------------#
        ...
        if open_posU1 == False:
            ...
            if table600.MA.iloc[i]*1.005>table600.Low.iloc[i]:
   ...
   # print("sellorders:", sellorder)  
    ...
    #print(signals)
    #print("Расчет..")
    profit1 = pd.concat([table600.Lower1[buys1], 0.995*table600.MA[takeL1]],axis=1)
    #profit1.to_excel("Lower1.xlsx")
    profit2 = pd.concat([table600.Lower2[buys2], 0.995*table600.MA[takeL2]],axis=1)
    #profit2.to_excel("Lower2.xlsx")
    profit3 = pd.concat([table600.Lower3[buys3], 0.995*table600.MA[takeL3]],axis=1)
    #profit3.to_excel("Lower3.xlsx")
    profit4 = pd.concat([table600.Upper1[sells1], 1.005*table600.MA[takeU1]],axis=1)
    #profit4.to_excel("Upper1.xlsx")
    profit5 = pd.concat([table600.Upper2[sells2], 1.005*table600.MA[takeU2]],axis=1)
    #profit5.to_excel("Upper2.xlsx")
    profit6 = pd.concat([table600.Upper3[sells3], 1.005*table600.MA[takeU3]],axis=1)
