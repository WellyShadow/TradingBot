    ...
    #--------------------------------------------------------------------------------------#
            ...
            if open_posU3 == False:
                ...
                if table600.MA.iloc[i]>table600.Low.iloc[i]:
                    ...
                    needback = False
            '''
            if open_posL1 == False and needback==True:
                if table600.Lower1.iloc[i]<table600.High.iloc[i]:
                    table600.Sell_Signal3.iloc[i] = True
                    open_posU3=True
                    sells3.append(i)
                    signals=signals+1
                    needback = False
            if open_posU1 == False and needback==True:
                if table600.Upper3.iloc[i]>table600.Low.iloc[i]:
                    table600.Sell_Signal3.iloc[i] = True
                    open_posU3=True
                    sells3.append(i)
                    signals=signals+1
